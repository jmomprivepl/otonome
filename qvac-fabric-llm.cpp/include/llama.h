...
extern "C" {
    ...
    // Look up a loaded tensor by GGUF name (e.g. blk.0.attn_q.weight). Returns NULL if not found.
    LLAMA_API struct ggml_tensor * llama_model_get_tensor(struct llama_model * model, const char * name);
